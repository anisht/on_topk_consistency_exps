...
if __name__ == '__main__':
	...
	# for alpha in [1,2]:
		...
		# for N in [10, 50, 100]:
		# for N in Ns:
		print(f"Running {num_trials} trials for N={N}, exp={exp_num}, alpha={alpha}")
		exp_res.append(repeat_experiment3(loss_dict, num_trials, K=k, N=N, alpha=alpha, EPOCHS=EPOCHS))
